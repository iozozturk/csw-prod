...
import csw.shared.params.models.Units
import csw.shared.params.models.Units.NoUnits
import csw.shared.params.pb.ItemsFactory
...
/**
 * A generic Key class. Never meant to be instantiated directly. [[csw.shared.params.generics.KeyType]] exposes
