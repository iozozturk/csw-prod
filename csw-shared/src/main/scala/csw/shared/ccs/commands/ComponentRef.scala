...
//import csw.shared.CommandMessage.{Oneway, Submit}
//import csw.shared.ccs.commands.CommandResponse.{Accepted, Completed, Error}
//import csw.shared.ccs.commands.matchers.{Matcher, StateMatcher}
//import csw.shared.ccs.commands.matchers.MatcherResponses.{MatchCompleted, MatchFailed}
//import csw.shared.params.models.RunId
//import csw.shared.{CommandResponseManagerMessage, ComponentMessage}
//
...
//
//  /**
//   * Submit a command and get a [[csw.shared.ccs.commands.CommandResponse]] as a Future. The CommandResponse can be a response
...
//   * @param controlCommand the [[csw.shared.ccs.commands.ControlCommand]] payload
...
//
//  /**
//   * Submit multiple commands and get a Source of [[csw.shared.ccs.commands.CommandResponse]] for all commands. The CommandResponse can be a response
...
//   * @param controlCommands the set of [[csw.shared.ccs.commands.ControlCommand]] payloads
...
//
//  /**
//   * Submit multiple commands and get one CommandResponse as a Future of [[csw.shared.ccs.commands.CommandResponse]] for all commands. If all the commands were successful,
//   * a CommandResponse as [[csw.shared.ccs.commands.CommandResponse.Completed]] will be returned. If any one of the command fails, an [[csw.shared.ccs.commands.CommandResponse.Error]]
//   * will be returned.
//   * @param controlCommands the set of [[csw.shared.ccs.commands.ControlCommand]] payloads
//   * @return [[csw.shared.ccs.commands.CommandResponse.Accepted]] or [[csw.shared.ccs.commands.CommandResponse.Error]] CommandResponse as a Future.
//   */
...
//
//  /**
//   * Send a command as a Oneway and get a [[csw.shared.ccs.commands.CommandResponse]] as a Future. The CommandResponse can be a response
...
//
//  /**
//   * Subscribe for the result of a long running command which was sent as Submit to get a [[csw.shared.ccs.commands.CommandResponse]] as a Future.
...
//
//  /**
//   * Submit a command and Subscribe for the result if it was successfully validated as `Accepted` to get a final [[csw.shared.ccs.commands.CommandResponse]] as a Future.
//   * @param controlCommand the [[csw.shared.ccs.commands.ControlCommand]] payload.
//   * @return a CommandResponse as a Future value.
//   */
...
//
//  /**
//   * Submit a command and match the published state from the component using a [[csw.shared.ccs.commands.matchers.StateMatcher]]. If the match is successful a `Completed` response is
...
//   * @param controlCommands the [[csw.shared.ccs.commands.ControlCommand]] payload.
//   * @return a Source of CommandResponse as a stream of CommandResponses for all commands
//   */
...
//   * [[csw.shared.ccs.commands.CommandResponse.Completed]] will be returned. If any one of the command fails, an [[csw.shared.ccs.commands.CommandResponse.Error]]
